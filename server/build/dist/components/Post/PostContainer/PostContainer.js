...
const PostContainer = ({author, date, image, ingredients, method, tags, title}) => {
  return /* @__PURE__ */ React.createElement("div", {
    className: "PostContainer m-10 p-10 border-4 border-gray-300 border-double rounded-md shadow-xl"
  }, /* @__PURE__ */ React.createElement(PostHeader, {
    author,
    title,
    date
  }), /* @__PURE__ */ React.createElement("div", {
    className: "grid grid-cols-2 grid-rows-3 bg-gray-100 bg-opacity-50 border-2 border-gray-200 rounded-xl m-5"
