...
const PostContainer = ({ author, date, image, ingredients, method, tags, title }) => {
    return (
        <div className="PostContainer m-10 p-10 border-4 border-gray-300 border-double rounded-md shadow-xl">
            <PostHeader author={ author } title={ title } date={ date } />
            <div className="grid grid-cols-2 grid-rows-3 bg-gray-100 bg-opacity-50 border-2 border-gray-200 rounded-xl m-5">
