...
const Post = props => {
    ...
    return (
        <div className="Post">
            <PostContainer author={ post.author } authorId={ post.authorId } date={ toLocaleDate(post.date) } image={ post.image } ingredients={ ingredients } method={ post.method } tags={ tags } title={ post.title } />
